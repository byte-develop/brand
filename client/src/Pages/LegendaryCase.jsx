...
const LegendaryCase = () => {
    ...
    const prizes = {
        ...
        "160 tokens": "../public/160_coins.png",
        "200 tokens": "../public/200_coins.png",
        "300 tokens": "../public/300_coins.png",
        "400 tokens": "../public/400_coins.png",
        "500 tokens": "../public/500_coins.png",
        "600 tokens": "../public/600_coins.png",
        "10%": "../public/10_promo.png",
        "20%": "../public/20_promo.png",
        "2G SORT": "../public/2_free_org.png",
        "2G MEOW": "../public/2_free_him.png"
    }
    ...
    const GetPrize = async () => {
        if (user && user.id) {
            setLoadind(true);
            try {
                const response = await fetch('/bonus/get_bonus/legendary', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
        ...
        <>
            {isMobile ?
                ...
                <div className='flex flex-col items-center justify-center mb-20'>
                    ...
                    <img src="../public/LegCaseText.png" className='h-[40px] mt-16 z-50' alt="" />

                    {
                        open ?
                            <div className="flex items-center justify-center w-[370px] h-[163px] border border-white rounded-2xl overflow-hidden relative mt-10 z-10">
                                <img src="../public/LegArrow.png" className='absolute right-[50%] top-0 translate-x-[50%] z-20' alt="" />
                            ...
                            <div className="relative w-full flex flex-col items-center justify-center">
                                <img src="../public/LegRight.png" className='absolute right-0 w-[40%]' alt="" />
                                <img src="../public/LegLeft.png" className='absolute left-0 w-[40%]' alt="" />
                                ...
                                {finalPrize ? (
                                    <div className='z-10 relative flex flex-col items-center'>
                                        ...
                                        {finalPrize == "../public/400_coins.png" && <img src="../public/stand.png" className='z-50 relative mt-4 h-[60px]'></img>}
                                        ...
                                        {finalPrize == "../public/160_coins.png" && <img src="../public/stand.png" className='z-50 relative mt-4 h-[60px]'></img>}
                                        ...
                                        {finalPrize == "../public/600_coins.png" && <img src="../public/red.png" className='z-50 relative mt-4 h-[60px]'></img>}
                                        {finalPrize == "../public/500_coins.png" && <img src="../public/red.png" className='z-50 relative mt-4 h-[60px]'></img>}

                                        {finalPrize == "../public/2_free_him.png" && <img src="../public/ex.png" className='z-50 relative mt-4 h-[60px]'></img>}
                                        {finalPrize == "../public/2_free_org.png" && <img src="../public/ex.png" className='z-50 relative mt-4 h-[60px]'></img>}
                                        <button onClick={() => setFinalPrize(false)} className='w-[200px] h-[60px] rounded-3xl mt-8 font-[OB] text-[16px] relative z-50' style={{ background: "linear-gradient(90deg, rgba(12,0,86,1) 0%, rgba(18,0,130,1) 25%, rgba(25,73,196,1) 75%, rgba(12,0,86,1) 100%)", boxShadow: '0px -4px 8px 0px rgba(12, 0, 86, 1) inset, 0px -2px 28px 2px rgba(97, 141, 255, 1)' }}>Получить</button>
                                    </div>
                                ) : (
                                    <div className="relative">
                                        ...
                                        <img src="../public/legendary.png" className="h-[175px] mt-12 transform transition-transform duration-300 ease-in-out z-10" alt="" />
                                    </div>
                                )}
                            </div>
                    }
                    ...
                    {!finalPrize ?
                        ...
                        <button onClick={GetPrize} disabled={loadind} className='w-[200px] h-[50px] rounded-2xl mt-8 font-[OB] text-[16px]' style={{ background: "linear-gradient(90deg, rgba(12,0,86,1) 0%, rgba(18,0,130,1) 25%, rgba(25,73,196,1) 75%, rgba(12,0,86,1) 100%)", boxShadow: '0px -4px 8px 0px rgba(12, 0, 86, 1) inset, 0px -2px 28px 2px rgba(97, 141, 255, 1)' }}>
                            {
                                loadind ?
                    ...
                    <div className='mt-8'>
                        <div className="flex justify-center flex-wrap">
                            <img className='h-[139px] w-[139px]' src={prizes["2G MEOW"]} alt="2G free him" />
                            <img className='h-[139px] w-[139px] ml-8' src={prizes["2G SORT"]} alt="2G free org" />
                            ...
                            <img className='h-[139px] w-[139px] mt-6' src={prizes["600 tokens"]} alt="600 coins" />
                            <img className='h-[139px] w-[139px] ml-8 mt-6' src={prizes["500 tokens"]} alt="500 coins" />
                            <img className='h-[139px] w-[139px] mt-6' src={prizes["400 tokens"]} alt="400 coins" />
                            ...
                            <img className='h-[139px] w-[139px] ml-8 mt-6' src={prizes["160 tokens"]} alt="160 coins" />
                ...
                <div className='flex flex-col items-center justify-center mb-20'>
                    <img src="../public/LegCaseText.png" className='h-[96px] mt-32' alt="" />
                            ...
                            <div className="relative w-full flex flex-col items-center justify-center">
                                ...
                                {finalPrize ? (
                                    <div className='z-10 relative'>
                                        ...
                                        {finalPrize == "../public/400_coins.png" && <img src="../public/stand.png" className='z-50 relative mt-8'></img>}
                                        ...
                                        {finalPrize == "../public/160_coins.png" && <img src="../public/stand.png" className='z-50 relative mt-8'></img>}
                                        ...
                                        {finalPrize == "../public/600_coins.png" && <img src="../public/red.png" className='z-50 relative mt-8'></img>}
                                        {finalPrize == "../public/500_coins.png" && <img src="../public/red.png" className='z-50 relative mt-8'></img>}

                                        {finalPrize == "../public/2_free_him.png" && <img src="../public/ex.png" className='z-50 relative mt-8'></img>}
                                        {finalPrize == "../public/2_free_org.png" && <img src="../public/ex.png" className='z-50 relative mt-8'></img>}
                                        <button onClick={() => setFinalPrize(false)} className='w-[300px] h-[60px]  rounded-3xl mt-16 font-[OB] text-[20px]' style={{ background: "linear-gradient(90deg, rgba(12,0,86,1) 0%, rgba(18,0,130,1) 25%, rgba(25,73,196,1) 75%, rgba(12,0,86,1) 100%)", boxShadow: '0px -4px 8px 0px rgba(12, 0, 86, 1) inset, 0px -2px 28px 2px rgba(97, 141, 255, 1)' }}>Получить</button>
                                    </div>
                                ) : (
                                    <div className="relative">
                                        <div className="bg-[#0028B8] bg-opacity-50 rounded-full absolute left-[50%] top-[50%] transform -translate-x-1/2 -translate-y-1/2" style={{ boxShadow: "0px 0px 150px 140px rgba(0, 40, 184, 0.7)" }}></div>
                                        <img src="../public/legendary.png" className="h-[359px] mt-20 transform transition-transform duration-300 ease-in-out z-10" alt="" />
                                    </div>
                                )}
                            </div>
                    }
                    ...
                    <div className='mt-24'>
                        <div className="flex justify-center">
                            <img className='h-[250px] w-[250px]' src={prizes["2G MEOW"]} alt="2G free him" />
                            <img className='h-[250px] w-[250px] ml-20' src={prizes["2G SORT"]} alt="2G free org" />
                        ...
                        <div className="flex justify-center mt-20">
                            <img className='h-[250px] w-[250px] ' src={prizes["600 tokens"]} alt="600 coins" />
                            <img className='h-[250px] w-[250px] ml-20' src={prizes["500 tokens"]} alt="500 coins" />
                            <img className='h-[250px] w-[250px] ml-20' src={prizes["400 tokens"]} alt="400 coins" />
                        </div>
                        ...
                        <div className="flex justify-center mt-20">
                            ...
                            <img className='h-[250px] w-[250px] ml-20' src={prizes["160 tokens"]} alt="160 coins" />
